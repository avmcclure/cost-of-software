        ...
        <div className="max-w-3xl w-full bg-white shadow-md rounded-xl p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 whitespace-nowrap">
              ...
              <input
                ...
                min="0"
                onChange={(e) =>
                  setDurationValue(parseFloat(e.target.value) || 0)
                }
              />
              <select
                className="border rounded p-2"
          ...
          <div className="bg-blue-50 rounded p-4">
            ...
            {results.roi === null ? (
              ...
              <>
                <p className="mt-2">
                  <strong>Runs until positive ROI:</strong>{' '}
                  {results.minRunsForPositiveROI}
                </p>
                <p className="mt-1">
                  <strong>Days until positive ROI:</strong>{' '}
                  {results.daysUntilPositiveROI !== null
                    ? results.daysUntilPositiveROI.toFixed(2)
                    : 'N/A'}
                </p>
